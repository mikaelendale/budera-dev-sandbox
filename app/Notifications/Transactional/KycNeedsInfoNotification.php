...
class KycNeedsInfoNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject(__('More information needed for wallet verification'))
            ->markdown('emails.wallet-kyc-needs-info', [
