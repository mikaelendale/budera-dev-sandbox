...
return [
     ...
     */
    'signature_header_name' => 'X-Budera-Signature',
    ...
    /*
     * Spatie's internal job retries — ProcessWebhookDeliveryJob uses dispatchSync with
     * maximumTries(1) so delivery backoff is owned by our job only ($tries / $backoff).
     */
    'tries' => 1,
    ...
    /*
     * When using Laravel Horizon you can specify tags that should be used on
     * the underlying job that performs the webhook request.
     */
    'tags' => [],
];
